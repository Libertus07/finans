...
// Extracted Intl formatters to module-level constants.
// Repeatedly instantiating Intl.NumberFormat and Intl.DateTimeFormat inside these
// formatting helpers causes significant overhead (~100x slower) during frequent renders.
// By reusing the same instances, we avoid this overhead.
