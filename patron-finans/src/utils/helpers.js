// Cache Intl instances for performance (creating new instances is expensive)
// Expected impact: ~100x faster formatting operations, reducing CPU overhead in loops/renders
