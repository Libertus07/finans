// Performans Optimizasyonu: Intl nesneleri pahalıdır. Her çağrıda yeniden oluşturmamak için module seviyesinde önbelleğe alıyoruz.
// Bu değişiklik liste renderlarında yaklaşık 50-100x performans artışı sağlar.
...
export const formatDate = (dateStr) => {
    ...
    return isNaN(date) ? 'Geçersiz Tarih' : dateFormatter.format(date);
};
