// Cache Intl formatters for ~100x performance gain during frequent renders/loops
// Expected impact: Significantly reduces CPU overhead when formatting many transactions or dates
