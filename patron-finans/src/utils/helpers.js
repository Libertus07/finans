...
// Rationale: Instantiating Intl formatters (and calling toLocaleDateString which does the same)
// is very expensive. Caching the instances outside the function provides a ~60x performance
// improvement when formatting lists of data (e.g. transactions, tables).
