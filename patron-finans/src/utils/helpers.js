// Instantiating formatters at the module level to avoid the performance overhead
// of creating a new Intl object on every render cycle (e.g. in lists or charts).
